...
export default function AdminBillingClientPicker() {
      ...
      <div className="bp-toolbar" style={{ marginBottom: 14 }}>
        <div style={{ flex: 1 }}>
          ...
          <p style={{ margin: '4px 0 0', fontSize: 13, color: 'var(--bp-muted)' }}>
            Select a client to open their billing dashboard for the current Financial Year.
          </p>
        </div>
        <input
          className="bp-input"
            ...
            <tbody>
              {rows.map((c) => (
                <tr key={c.id}>
                  ...
                  <td>
                    <Link className="bp-btn bp-btn-primary" style={{ padding: '4px 10px', fontSize: 12 }} to={`/admin/clients/${c.id}/billing`}>
                      Open Billing
                    </Link>
                  </td>
                </tr>
