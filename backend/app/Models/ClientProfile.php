...
class ClientProfile extends Model
{
    protected $fillable = [
        ...
        'gstin', 'has_gst', 'gst_compliance_enabled', 'dealer_type', 'composition_rate', 'gst_filing_frequency', 'gstr1_filing_frequency', 'pan', 'email', 'state_code', 'state', 'country', 'place_of_supply_default',
